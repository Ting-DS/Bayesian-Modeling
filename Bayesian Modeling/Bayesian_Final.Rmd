...
```{r out.width="100%"}
knitr::include_graphics("/Users/tinglu/Documents/DATA/Model/Statistics/bayesian/Final/IBB.png",error = F)
```

### Data information
```{r}
IBB = read.csv("/Users/tinglu/Documents/DATA/Model/Statistics/bayesian/Final/IBBENS.csv")
head(IBB)
...
```{r out.width="100%"}
knitr::include_graphics("/Users/tinglu/Documents/DATA/Model/Statistics/bayesian/Final/IBB2.png",error = F)
```
...
```{r}
toe = read.table("/Users/tinglu/Documents/DATA/Model/Statistics/bayesian/Final/toenail.txt", header=T)
head(toe)
```
...
```{r out.width="100%"}
knitr::include_graphics("/Users/tinglu/Documents/DATA/Model/Statistics/bayesian/Final/toe.png",error = F)
```
...
$$
```{r out.width="100%"}
knitr::include_graphics("/Users/tinglu/Documents/DATA/Model/Statistics/bayesian/Final/toe2.png",error = F)
```
...
```{r out.width="100%"}
knitr::include_graphics("/Users/tinglu/Documents/DATA/Model/Statistics/bayesian/Final/toe3.png",error = F)
```
...
```{r out.width="100%"}
knitr::include_graphics("/Users/tinglu/Documents/DATA/Model/Statistics/bayesian/Final/poi.png",error = F)
```
